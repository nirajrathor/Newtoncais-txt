...
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text("Hi!\n\nGive /shuklapanditnakul Command to Downlaod From a Text file.\n")
...
@bot.on_message(filters.command(["shuklapanditnakul"]))
async def account_login(bot: Client, m: Message):
